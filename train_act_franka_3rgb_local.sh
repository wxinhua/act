...
#         --ckpt_dir ./ckpt_dir/ACT_camlrt/241112/table/franka_3rgb_multi_task_2_lr1e5_batch24_chunk50 \
...
CUDA_VISIBLE_DEVICES=0 python3 train_algo.py \
        ...
        --ckpt_dir ./ckpt_dir/ACT_camlrt/241121/table/pick_plate_from_plate_rack_lr1e5_batch24_chunk50 \
        --exp_type franka_3rgb \
        --agent_class ACT \
        --batch_size_train 24 --batch_size_val 24 \
        --chunk_size 50 --hidden_dim 512 --dim_feedforward 3200 \
        ...
        --num_steps 100000 --eval_every 100001 --validate_every 500 --save_every 50000 \
        --use_wandb \
        --wandb_name ACT_camlrt_pick_plate_from_plate_rack_lr1e5_batch24_chunk50 \
