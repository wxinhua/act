...
CUDA_VISIBLE_DEVICES=0 python3 train_algo.py \
        ...
        --camera_names camera_top \
        --ckpt_dir ./ckpt_dir/ACT_camt/241121/table/ur_1rgb_open_top_white_drawer_lr1e5_batch24_chunk50 \
        --exp_type ur_1rgb \
        --agent_class ACT \
        ...
        --use_wandb \
        --wandb_name ACT_ur_1rgb_camlrt_open_top_white_drawer_lr1e5_batch24_chunk50 \
