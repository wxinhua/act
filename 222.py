...
def process_bag(bag):
    ...
    try:
        ...
        h5_path = bag_file_path.replace('/nfsroot/DATA/Robot_DATA/tiangong/data/tiangong_dataset1', '/nfsroot/DATA/users/embodied_ai/felix_yang/h5_tiangong')
...
if __name__ == "__main__":
    directory = "/home/leimao/data/tiangong_mt"  # raw_data path
    h5_path = "/home/leimao/data/tiangongh5_30hz/" # h5 data path
    reference_topic = "/camera/color/image_raw"   # topic to align all the data
    main('/nfsroot/DATA/Robot_DATA/tiangong',h5_path,reference_topic)