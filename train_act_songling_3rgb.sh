...
#         --ckpt_dir ./ckpt_dir/ACT_camlrt/241112/table/songling_3rgb_multi_task_2_lr1e5_batch24_chunk50 \
...
#         --use_wandb \
#         --wandb_name ACT_songling_3rgb_camlrt_multi_task_2_lr1e5_batch24_chunk50 \
...
CUDA_VISIBLE_DEVICES=0 python3 train_algo.py \
        ...
        --camera_names camera_front camera_left_wrist camera_right_wrist \
        --ckpt_dir ./ckpt_dir/ACT_camlrt/241121/table/songling_3rgb_28_packtable_2_lr1e5_batch24_chunk50 \
        --exp_type songling_3rgb \
        --agent_class ACT \
        ...
        --use_wandb \
        --wandb_name ACT_songling_3rgb_camlrt_28_packtable_2_lr1e5_batch24_chunk50 \
