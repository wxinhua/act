...
# /media/ps/Extreme\ Pro_1/wk/benchmark_results/act/ur_1rgb_close_trash_can/ckpt \

python3 deploy_algo.py \
        --task_name ur_1rgb_pick_up_long_bread \
        --camera_names top \
        --ckpt_dir /home/ps/wk/benchmark_results/act/ur_1rgb_pick_up_long_bread/ckpt \
        --exp_type ur_1rgb \
